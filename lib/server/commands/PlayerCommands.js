...
import { MessageType, MoveDirection } from "../../interfaces/Messages.js";
import MatterJS from "matter-js";
export class OnPlayerJoinedCommand extends Command {
    execute(sessionId) {
...
export class OnPlayerLeaveCommand extends Command {
    execute(sessionId) {
...
export class OnPlayerInputCommand extends Command {
    execute(payload) {
